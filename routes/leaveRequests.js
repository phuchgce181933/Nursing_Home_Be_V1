...
router.post('/', protect, authorize('admin', 'doctor', 'nurse', 'caregiver', 'pharmacist'), submitLeaveRequest);
...
router.delete('/:id', protect, authorize('admin', 'doctor', 'nurse', 'caregiver', 'pharmacist'), cancelLeaveRequest);
